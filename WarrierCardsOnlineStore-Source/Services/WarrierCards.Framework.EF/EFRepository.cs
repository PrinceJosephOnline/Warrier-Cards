...
Log
Date			Author			Comment
09-Jul-2012		Prince      	Class created
*/
    ...
    public class EFRepository : GenericRepository, IUnitOfWork, IDisposable
    {
        ...
        public override void Update<TEntity>(TEntity entity)
        {
            ...
            if (!this.Context.TryGetObjectByKey(entityKey, out originalItem))
            {
                ...
                throw new WarrierCards.Framework.DAL.Exceptions.OptimisticConcurrencyException(Messages.ObjectDoesNotLongerExists, entity.GetType().Name, entityKey);
            }
